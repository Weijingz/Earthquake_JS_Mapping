...
function createMap(earthquakes){
    ...
    var token="pk.eyJ1Ijoid2VpamluZ3oiLCJhIjoiY2poeG8wcHBhMGRzejNvb2JmcTRpcHpyaSJ9.Ec7nuF9yfUqdjsbiVfMaZw";
    // Creating Satellite Map tile Layer

    var satellitemap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/satellite-v8/tiles/256/{z}/{x}/{y}?access_token="+token);
